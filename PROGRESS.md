...
> 마지막 갱신: 2026-05-21 (5월 마일스톤 작업 순서 조정)
...
- [ ] **[2] 게임 내실 다지기** — `game-designer` 에이전트로 4박자 사이클(Plan/Grind/Pop/Loop) 진단 → 7분 견딜 만한 콘텐츠/페이싱 조정 (적/유닛 다양화, 보상 곡선, 페이스 등)
- [ ] **[3] 튜토리얼 1페이지** — 시작 시 한 화면 안내 (소환/교배/합성 한 번에)
