...
| 지표 | 목표값 | 실패 시 |
|---|---|---|
| 4티어 완성 평균 시점 | **4:00~5:00** | 너무 빠르면 U7(분당 곱 1.25→1.35), 너무 늦으면 자동지급 +2 |
...
| 스테이지 | 1/2/3 구현. Stage2 FAST↑/TANK2분, Stage3 TANK1분/보스HP×22 |
| 고티어 선택권 | 부분 — 레시피 팝업으로 "어떤 조합이 뭐 되나" 공개 |

### 미결정

- [ ] 스테이지 구조 확장 (개수 / 챕터 / 클리어 조건)
- [ ] 메타프로그레션 2차 트리 (시너지 해금 / 스타터 유닛 선택)
- [ ] 시너지 카탈로그 5~10개
- [ ] 아트 방향 — 이모지 유지 vs NovelAI 자산 도입 (의뢰서 준비 완료, 시드 미정)
...
- ✅ 무한 모드 (오버클록 매초 기하급수)
- ✅ 메타프로그레션: 영구 강화 4종 + 💎 보석 화폐 + 게임 2배속(💎3)
