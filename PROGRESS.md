...
| P0-3 | **34번 D: T3-only 승리 시뮬** — `scripts/sim-t3-ceiling.ts`(선례 sim-bloodline, esbuild→node). T4 0기 빌드 3종 비교로 W2/W3 Phase C 승리 가능성 판정. fail 시 노브 후보 3개(34번 §4)만 보고, 자동 적용 금지 | 하위 모델 | 34번 §4 스펙. A안/C안 재개 여부가 이 결과에 걸림 |
