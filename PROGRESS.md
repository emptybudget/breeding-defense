...
> 마지막 갱신: 2026-05-23 (재미 증대 1순위 3개 완료)

<<<<<<< HEAD
## 🚨 최우선 다음 작업 — 재미 증대 2순위

1순위 3개 완료. 다음 세션은 2순위로 진행. (PROGRESS.md 하단 🎯 섹션 C/H/F/D/E 참조)

| 완료 | 기능 | 핵심 파일 |
|---|---|---|
| ✅ | 3/4티어 완성 시 **ULTIMATE 연출** (0.3초 freeze + 화면 플래시) | `DragController.ts` |
| ✅ | 적 40마리 이상 → **화면 테두리 붉은 맥동** | `GameScene.ts` |
| ✅ | 합성 가능 유닛 쌍 → **빛나는 테두리 링** | `UnitRenderer.ts` |

**완료 기준:** `npm run build` 통과 + 사용자 IDX 미리보기 확인.
세부 설명은 하단 **🎯 재미 증대 후보 기능** 섹션 참조.
=======
## ✅ 재미 증대 1순위 3개 완료
...
**다음:** 7분 풀플레이 → Firebase Hosting 배포
>>>>>>> 029b49d475df15058e2b6b3b36c09e95706585b2
